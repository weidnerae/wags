...
public class EditingPanelUi extends Composite {
	...
	public EditingPanelUi(RefrigeratorMagnet magnet, int tabPanelHeight,String title, String directions, StackableContainer mainFunction, StackableContainer[] insideSegments, String problemType, StackableContainer[] premadeSegments ,int numCreatedStatements, int numStatements, String[] structuresList, String[] for1List,String[] for2List,String[] for3List, String[] booleanList, String solution, String[] premadeIDs, PickupDragController dc) {
		initWidget(uiBinder.createAndBindUi(this));
		construct = new ConstructUi(problemType, premadeSegments,Integer.parseInt(premadeSegments[premadeSegments.length-1].getID()), title, directions, structuresList, for1List, for2List, for3List, booleanList, dc);
