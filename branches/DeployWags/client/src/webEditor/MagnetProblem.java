...
public class MagnetProblem {
	...
	public String[] innerFunctions, forLeft, forMid, forRight, ifOptions, whileOptions, statements, createdIDs;
	
	public MagnetProblem(int id, String title, String directions, String type, String mainFunction,
			String[] innerFunctions, String[] forLeft, String[] forMid, String[] forRight, String[] ifOptions, String[] whileOptions, String[] statements, 
