...
public class ModifiedCreationStation extends VerticalPanel{
	...
	private String DBString = ""; // String for the containers to be stored in for input into the database.
	//private TextArea textArea = new TextArea();
	public PickupDragController dragControl = new PickupDragController(RootPanel.get(),false);
